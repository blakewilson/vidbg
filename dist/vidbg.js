...
/* harmony import */ var hex_rgb__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! hex-rgb */ "./node_modules/hex-rgb/index.js");
/* harmony import */ var hex_rgb__WEBPACK_IMPORTED_MODULE_8___default = /*#__PURE__*/__webpack_require__.n(hex_rgb__WEBPACK_IMPORTED_MODULE_8__);
  ...
  function vidbg(selector, options, attributes) {
    ...
    _defineProperty(this, "createOverlay", function () {
      ...
      if (_this.options.overlay) {
        ...
        var rgb = hex_rgb__WEBPACK_IMPORTED_MODULE_8___default.a.hex.rgb(_this.options.overlayColor); // Use the converted rgb with the overlayAlpha to set the backgroundColor

        _this.overlayEl.style.backgroundColor = "rgb(".concat(rgb.red, ", ").concat(rgb.green, ", ").concat(rgb.blue, ", ").concat(_this.options.overlayAlpha, ")");
      }
