  ...
  function vidbg(selector, options, attributes) {
    ...
    _defineProperty(this, "createOverlay", function () {
      ...
      if (_this.options.overlay) {
        ...
        var rgb = color_convert__WEBPACK_IMPORTED_MODULE_8___default.a.hex.rgb(_this.options.overlayColor); // Use the converted rgb with the overlayAlpha to set the backgroundColor
